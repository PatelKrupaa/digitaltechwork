    ...
    <div className="">
      ...
      <div className="grid lg:grid-cols-5 md:grids-cols-5  ">
        <div className="lg:col-span-2">
          <a
            href="#"
            className="flex items-center  bg-2575FC lg:w-80 md:w-56 sm:w-40 h-14 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-2575FC focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 rounded-xl px-6 "
          >
            <span>01</span>
          ...
          {TechStacks.map((item) => {
            return (
              <div className="lg:flex lg:flex-1 md:flex sm:flex  mt-3">
                <a
                  href="#"
                  className="flex w-64 bg-spl-grey lg:w-80 md:w-56 sm:w-40 h-14  py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-2575FC focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 rounded-xl px-6 gap-3"
                >
                  <span>{item.id}</span>
